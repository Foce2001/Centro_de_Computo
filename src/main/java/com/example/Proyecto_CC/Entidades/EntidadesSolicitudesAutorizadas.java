 ...
 */
@Entity
@Table(name = "solicitudes_autorizadas")

public class EntidadesSolicitudesAutorizadas {
     @Id
    private int id;
    ...
    public EntidadesSolicitudesAutorizadas() {
    }

    public EntidadesSolicitudesAutorizadas(int id, String nombre, int no_personal, String correo, String seccion, String materia, String centro_de_computo, Date fecha, Time hora_inicio, Time hora_fin, String carrera, String estado) {
        this.id = id;
        this.nombre = nombre;
